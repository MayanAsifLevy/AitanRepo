...
--   `FruitName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
--   `FruitType` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
--   `Is_Active` int default 1,
--   PRIMARY KEY (`FruitType`)
-- ) 

CREATE TABLE `FruitSize` (
  `FruitSize` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Is_Active` int default 1,
  PRIMARY KEY (`FruitSize`)
) 
